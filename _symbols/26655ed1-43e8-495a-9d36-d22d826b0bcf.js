// Article Header - Updated January 27, 2025
function noop() { }
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*links*/ 4) && t0_value !== (t0_value = /*link*/ ctx[5].label + "")) set_data(t0, t0_value);
			const icon_changes = {};
			if (dirty & /*links*/ 4) icon_changes.icon = /*icon*/ ctx[6];
			icon.$set(icon_changes);

			if (!current || dirty & /*links*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[5].url)) {
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t2 = claim_text(span0_nodes, /*title*/ ctx[3]);
			...
			t4 = claim_text(span1_nodes, /*date*/ ctx[0]);
			...
			t6 = claim_text(h2_nodes, /*title*/ ctx[3]);
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "svelte-16u36xe");
			attr(span0, "class", "svelte-16u36xe");
			attr(div0, "class", "breadcrumbs svelte-16u36xe");
			attr(span1, "class", "date svelte-16u36xe");
			attr(h2, "class", "heading svelte-16u36xe");
			attr(div1, "class", "links svelte-16u36xe");
			attr(div2, "class", "svelte-16u36xe");
			attr(div3, "class", "article-info svelte-16u36xe");
			attr(div4, "class", "section-container svelte-16u36xe");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*date*/ 1) set_data(t4, /*date*/ ctx[0]);
			if (!current || dirty & /*title*/ 8) set_data(t6, /*title*/ ctx[3]);
...
function instance($$self, $$props, $$invalidate) {
	...
	return [date, image, links, title, props];
}
